...
class DCGAN(object):
    ...
    def build_model(self):
        ...
        self.saver_g = tf.compat.v1.train.Saver(max_to_keep=5, var_list=self.g_save_vars)
    ...
    def train_together(self, config):
        ...
        for i in range(self.batch_teachers):
            ...
            d_optim_list.append(optimizer.apply_gradients(zip(gradients, self.d_vars[i]),name=None))
