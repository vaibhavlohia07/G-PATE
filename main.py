...
flags.DEFINE_boolean("shuffle", False, "Evenly distribute dataset")
flags.DEFINE_boolean("save_epoch", True, "Save each epoch per 0.1 eps")
# new flag
...
def main(_):
    ...
    run_config =  tf.compat.v1.GPUOptions(per_process_gpu_memory_fraction=0.333)
